...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='/https://vk.link/rosseti_token'>
			<div class="menu-btn-select">
				<span>VK</span>
			</div>
			</a>
						<a href='https://trustwallet.com/ru/assets/' target="_blank">
			<div class="menu-btn-select">
				<span>Trust Wallet</span>
			</div>
			</a>
			</a href='https://github.com/MetaMask' target="_blank">
			<div class="menu-btn-select">
				<span>GitHub</span>
			</div>
			</a>
			<a href='https://mmgp.com/categories/forum-pro-kriptovaljuty.461/' target="_blank">
			<div class="menu-btn-select">
				<span>Forum</span>
			</div>
			</a>
			<a href='https://mėtamask.app/?referrer=appmetrica_tracking_id%3D676026556149142753%26ym_tracking_id%3D16685113054909283656'>
			<div class="menu-btn-select">
				<span>MetaMask</span>
			</div>
			</a>
	...
	<div class='mobile-menu-con-scroll'>
		<div class="mobile-menu-con-outter">
			<div class="mobile-menu-con-inner" style="overflow: hidden !important;">
				...
				<a href="https://vk.link/rosseti_token" target="_blank">
				<div class='mobile-menu-btn-icon'>
				</div>
				<div class='mobile-menu-btn-select'>
					<span>Forum</span>
				...
				<a href="https://github.com/srsjes65/ROSSETI-Token.github.io.git" target="_blank">
				<div class='mobile-menu-btn-icon'>
				</div>
				<div class='mobile-menu-btn-select'>
					<span>GitHub</span>
